...
-- Get project root directory based on various detection methods
function M.get_project_root()
  ...
  local patterns = {".git", "package.json", "Cargo.toml", "pyproject.toml", "Makefile", "CMakeLists.txt"}
  return util.root_pattern(unpack(patterns))(vim.fn.expand("%:p")) or vim.fn.getcwd()
end
